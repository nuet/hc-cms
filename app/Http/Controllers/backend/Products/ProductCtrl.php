...
class ProductCtrl extends Controller {
    ...
    public function __construct() {
        $this->data['title'] = ucfirst(trans('sidebar.product'));
    }
    ...
    public function index() {
        ...
        $this->data['sub_title'] = ucfirst(trans('sidebar.list')).' '.trans('sidebar.product');
...
//        return response()->json(compact('aaData'));
    ...
    public function create() {
        ...
        $this->data['sub_title'] = ucfirst(trans('sidebar.addnew')).' '.trans('sidebar.product');
    ...
    public function edit($id) {
        ...
        $this->data['sub_title'] = ucfirst(trans('sidebar.edit')).' '.trans('sidebar.product');
