        ...
        <div class="row">
                    ...
                    <main id="main" class="site-main" role="main">
                        <div class="home-desc clearfix">
                            ...
                            <div class="row desc">
                                ...
                                <div class="col-sm-8">
                                    <p style="text-align: center;"><strong>TRUNG TÂM GIẢI TRÍ VÀ THỂ THAO THẾ HỆ MỚI</strong>
                                    </p>
                        ...
                        <div class="home-products">
                            ...
                            <div class="item">
                                <h2><a href="http://dongamruou.vn/danh-muc/nam-ngoc-cau/" title="Nấm Ngọc Cẩu">Trò Chơi Ngoài Trời</a></h2>
                                <div class="woocommerce columns-3">
                            ...
                            <div class="item">
                                <h2><a href="http://dongamruou.vn/danh-muc/sam-cau/" title="Sâm Cau">Tổ Chức Sự Kiện</a>
                                </h2>
                                <div class="woocommerce columns-3">
            ...
            <div id="secondary" class="hidden-sm hidden-xs widget-area col-md-3 col-md-pull-9" role="complementary">
                ...
                <aside id="widget_sp_image-3" class="widget-2 widget-even widget widget_sp_image">
                    <h2 class="widget-title"><span>Ảnh hoạt động</span></h2>
                    <a href="#" target="_blank" class="widget_sp_image-image-link" title="Kho Ngâm Rượu">
                        @foreach(Gen::getMedia(Config::get('constants.mediatype.slide'),'8') as $key =>$ss)
                            <img width="800" height="480" class="attachment-full" style="max-width: 100%;" src="{{asset(Gen::genImgUrl($ss->path_full))}}?w=800">
                        @endforeach
                    </a>
                </aside>

                <aside id="sticky-posts-3" class="widget-3 widget-odd widget widget_ultimate_posts"><h2
                            class="widget-title"><span><a
                                    href="http://dongamruou.vn/cach-ngam/">Tin hoạt động</a></span></h2>

                    <div class="upw-posts hfeed">


                        <article
                                class="post-2501 post type-post status-publish format-standard has-post-thumbnail hentry category-cach-ngam fancy-gallery-content-unit">
                                ...
                                <div class="entry-image">
                                    <a href="#" rel="bookmark">
                                        <img width="150" height="150"
                                             src="http://dongamruou.vn/wp-content/uploads/2016/11/nam-cha-ga-150x150.jpg"
                                             class="attachment-thumbnail wp-post-image" alt="nam chaga"> </a>
                                </div>

                                <h4 class="entry-title">
                                    <a href="http://dongamruou.vn/cach-ngam-ruou-nam-chaga/" rel="bookmark">
                                        Khu vui chơi thể thao thế hệ mới mai khai trương ca Fe </a>
                                </h4>
                        ...
                        <article
                                class="post-2400 post type-post status-publish format-standard has-post-thumbnail hentry category-cach-ngam fancy-gallery-content-unit">
                            ...
                            <header>
                                ...
                                <div class="entry-image">
                                    <a href="#" rel="bookmark">
                                        <img width="150" height="150"
                                             src="http://dongamruou.vn/wp-content/uploads/2016/09/nam-tich-duong-150x150.jpg"
                                             class="attachment-thumbnail wp-post-image" alt="nấm tích dương"> </a>
                                </div>

                                <h4 class="entry-title">
                                    <a href="" rel="bookmark">
                                        THÔNG BÁO KHUYẾN MÃI BÓNG ĐÁ </a>
                                </h4>
                        ...
                        <article
                                class="post-2394 post type-post status-publish format-standard has-post-thumbnail hentry category-cach-ngam fancy-gallery-content-unit">

                            <header>

                                <div class="entry-image">
                                    <a href="http://dongamruou.vn/cach-ngam-ruou-lan-kim-tuyen/" rel="bookmark">
                                        <img width="150" height="150"
                                             src="http://dongamruou.vn/wp-content/uploads/2016/09/ruou-lan-kim-tuyen-150x150.jpg"
                                             class="attachment-thumbnail wp-post-image" alt="ruou lan kim tuyen">
                                    </a>
                                </div>

                                <h4 class="entry-title">
                                    <a href="" rel="bookmark">
                                        Trung tâm Giải trí và Thể thao Thế Hệ Mới, huyện Lệ Thuỷ, tỉnh Quảng Bình đang đẩy nhanh...</a>
                                </h4>
