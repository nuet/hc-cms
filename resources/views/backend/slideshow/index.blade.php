...
$(document).ready(function() {
    ...
    $.get('{{ langRoute("api.slideshow") }}', {}, function(data) {
        $('#nestable').html(data);
            ...
            bootbox.confirm("Are you sure to delete this page?", function(result) {
                if (result) {
                    ...
                    $('#nestable').slideUp(function() {
                        $.ajax({
                            url: '{{langURL("backend/slideshow")}}/' + id,
                            type: 'DELETE',
                            data: data,
    ...
    $('#save').click(function(e) {
        $('#nestable').slideUp(function() {
            ...
            $.post('{{langRoute("api.postslideshow")}}', data, function(e) {
                $('#nestable').html(e);
            }).done(function() {
                $('#nestable').slideDown();
            });
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <a class="btn btn-success" href="{{langRoute('backend.slideshow.create')}}">Add Slideshow</a>
