        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <form id="frmAddImage" role="form" action='' method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id_obj" id="id_obj" value="{{$image->id_obj}}">
                    <input type="hidden" name="type" id="type" value="{{$image->type}}">

                    <div class="box-body">
                        <div class="form-group">
                            <label for="img_name">Name</label>
                            <input type="text" value="{{$image->img_name}}" class="form-control" id="img_name" placeholder="Enter Name" name='img_name'>
                        </div>
                        <div class="form-group">
                            <label for="img_url">URL</label>
                            <input type="text" value="{{$image->img_url}}" class="form-control" id="img_url" placeholder="Enter URL" name='img_url'>
                        </div>
                        <div class="form-group" id="fcontent">
                            <label for="img_description">Description</label>
                            <textarea id="summernote" name="img_description" class="form-control">{{$image->img_description}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="path_full">Image</label>
                            <div>
                                <input type="text" value="{{$image->path_full}}" style="width: 80%;display: inline-block;float: left;" class="form-control" id="path_full" placeholder="Enter Path" name='path_full'>
                                <input type="button" class="btn btn-primary" value="Chọn ảnh ..." id="btnSelectImg2" name="btnSelectImg2" />
                            </div>
                        </div>
                    </div><!-- /.box-body -->
