    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <form role="form" action='{{langRoute('backend.user.update',$user->id)}}' method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$user->username}}" class="form-control" id="username" placeholder="Enter Username" name='username'>
                        </div>
                        <div class="form-group">
