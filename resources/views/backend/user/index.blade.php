...
$(document).ready(function() {
    var roles = function() {
        $.get("{{langRoute('backend.role.index')}}", function(data) {
            $("#roles").html(data);
        });
    };
    var perm = function() {
        $.get("{{langRoute('perm')}}", function(data) {
            $("#perm").html(data);
        });
    };
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <div class="btn-group">
                        <a href="{{langRoute('backend.user.create')}}" class="btn btn-default">Add User</a>
                        <a href="{{langRoute('backend.role.create')}}" class="btn btn-default">Add Role</a>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                                ...
                                <table id="product-table" class="table table-bordered table-striped table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a class="btn btn-primary " href="{{langRoute('backend.user.edit',$user->id)}}">Edit</a>
