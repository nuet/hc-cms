    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <form role="form" action='{{langRoute('backend.user.store')}}' method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('last_name')}}" class="form-control" id="last_name" placeholder="Enter Last Name" name='last_name'>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('username')}}" class="form-control" id="username" placeholder="Enter Username" name='username'>
                        </div>
                        <div class="form-group">
