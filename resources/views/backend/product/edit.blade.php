                        ...
                        <div class="col-md-12">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#add_pro" data-toggle="tab">{{ucfirst(trans('sidebar.edit')).' '.trans('sidebar.product')}}</a></li>
                                    <li><a href="#add_image" data-toggle="tab">{{trans('sidebar.image')}}</a></li>
                                    <li><a href="#add_meta" data-toggle="tab">Meta</a></li>
                                </ul>
                                    ...
                                    <div class="tab-pane active" id="add_pro">
                                        <form role="form" method="post" action="{{route('backend.product.update',$product->id)}}" enctype="multipart/form-data">
                                            ...
                                            <div class="input_fields_wrap">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @if($key != 0)
                                                        <div class="col-xs-3">
                                                            <button type="button" class="btn btn-default remove_field">Xóa thuộc tính</button>
                                                        </div>
                                                        @endif
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label>
                                                    @if($product->status == 1)
                                                    <input type="checkbox" class="minimal" name='status' checked /> {{ucfirst(trans("sidebar.active"))}} ?
                                                    @else
                                                    <input type="checkbox" class="minimal" name='status' /> {{ucfirst(trans("sidebar.active"))}} ?
                                                    @endif
                                                </label>
                                            </div>
                                            <div class="form-group">
