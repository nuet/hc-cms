<ol class="dd-list">
    ...
    <li class="dd-item" data-id="{{$page['id']}}">
        ...
        <div class="dd3-content">{{$page['page_name']}}
            ...
            <a class="btn btn-xs btn-primary pull-right" href="{{langRoute('backend.page.edit',[$page['id'],'position' => $page['page_position']])}}">Edit</a>
        </div>
        @if($page['children'])
        <ol class="dd-list">
            ...
            <li class="dd-item" data-id="{{$child['id']}}">
                ...
                <div class="dd3-content">{{$child['page_name']}}
                    ...
                    <a class="btn btn-xs btn-primary pull-right" href="{{langRoute('backend.page.edit',[$child['id'],'position' => $child['page_position']])}}">Edit</a>
                </div>
            </li>
            @endforeach
        </ol>
